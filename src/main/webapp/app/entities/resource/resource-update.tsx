  ...
  return (
    <div className="l-card">
      {loading ? (
        ...
        <>
          <h5>
            <Translate contentKey="lxmcmsApp.resource.home.createOrEditLabel">Create or edit a Resource</Translate>
          </h5>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="l-form">
              ...
              <div>
                <label htmlFor="name">
                  <Translate contentKey="lxmcmsApp.resource.name" />
                </label>
                <div>
                  <Controller
                    control={control}
                    ...
                    render={({ field, fieldState }) => (
                      <InputText
                        ...
                        tooltip={translate('lxmcmsApp.resource.help.name')}
                      />
                    )}
                  />
              ...
              <div>
                <label htmlFor="permission">
                  <Translate contentKey="lxmcmsApp.resource.permission" />
                </label>
                <div>
                  <Controller
                    control={control}
                    ...
                    render={({ field, fieldState }) => (
                      <InputText
                        ...
                        tooltipOptions={{ position: 'top' }}
                        tooltip={translate('lxmcmsApp.resource.help.permission')}
                      />
                    )}
                  />
              ...
              <div>
                <label htmlFor="authority">
                  <Translate contentKey="lxmcmsApp.resource.authority" />
                </label>
                <div>
                  <Controller
                    control={control}
                    ...
                    render={({ field, fieldState }) => (
                      <Dropdown
                        ...
                        tooltipOptions={{ position: 'top' }}
                        tooltip={translate('lxmcmsApp.resource.help.authority')}
                      />
                    )}
                  />
                </div>
