...
export const ResourceDetail = () => {
  ...
  return (
    <div className="l-card">
      <h5>
        <Translate contentKey="lxmcmsApp.resource.detail.title">Resource</Translate>
      </h5>
      <div className="l-form">
        ...
        <div>
          <label id="name" data-pr-position="top" data-pr-at="left+5 top-5" data-pr-tooltip={translate('lxmcmsApp.resource.help.name')}>
            <Translate contentKey="lxmcmsApp.resource.name">Name</Translate>
          </label>
          <Tooltip target="#name" />
        ...
        <div>
          <label
            ...
            data-pr-tooltip={translate('lxmcmsApp.resource.help.permission')}
          >
            <Translate contentKey="lxmcmsApp.resource.permission">Permission</Translate>
          </label>
        ...
        <div>
          <label>
            <Translate contentKey="lxmcmsApp.resource.authority">Authority</Translate>
          </label>
