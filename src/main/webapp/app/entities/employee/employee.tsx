...
export const Employee = () => {
  ...
  const allColumns: LxmColumnProps[] = [
    {
      field: 'id',
      headerKey: 'lxmcmsApp.employee.id',
      sortable: true,
    },
    {
      field: 'title',
      headerKey: 'lxmcmsApp.employee.title',
      sortable: true,
      filter: true,
    },
    {
      field: 'nickName',
      headerKey: 'lxmcmsApp.employee.nickName',
      sortable: true,
      filter: true,
    },
    {
      field: 'user.login',
      headerKey: 'lxmcmsApp.employee.user',
      sortable: true,
      body: rowData => {
    ...
    },
    {
      ...
      headerKey: 'lxmcmsApp.employee.reportsTo',
      sortable: true,
      body: rowData => {
        return (
          rowData.reportsTo && (
  ...
  const header = (
    <div className="l-datatable-header">
      <h5>
        <Translate contentKey="lxmcmsApp.employee.home.title">Employees</Translate>
      </h5>
      <MultiSelect
    ...
    <>
      <div className="l-card">
        ...
        <DataTable
          ...
          header={header}
          emptyMessage={translate('lxmcmsApp.employee.home.notFound')}
      ...
      >
        <div className="confirmation-content">
          ...
          {employee && (
            <Translate contentKey="lxmcmsApp.employee.delete.question" interpolate={{ id: employee.id }}>
