  ...
  return (
    <div className="l-card">
      {loading ? (
        ...
        <>
          <h5>
            <Translate contentKey="lxmcmsApp.employee.home.createOrEditLabel">Create or edit a Employee</Translate>
          </h5>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <div className="l-form">
              ...
              <div>
                <label htmlFor="title">
                  <Translate contentKey="lxmcmsApp.employee.title" />
                </label>
                <div>
                  <Controller
                    control={control}
                    ...
                    render={({ field, fieldState }) => (
                      <InputText
                        ...
                        tooltip={translate('lxmcmsApp.employee.help.title')}
                      />
                    )}
                  />
              ...
              <div>
                <label htmlFor="nickName">
                  <Translate contentKey="lxmcmsApp.employee.nickName" />
                </label>
                <div>
                  <Controller
                    control={control}
                    ...
                    render={({ field, fieldState }) => (
                      <InputText
                        ...
                        tooltipOptions={{ position: 'top' }}
                        tooltip={translate('lxmcmsApp.employee.help.nickName')}
                      />
                    )}
                  />
              ...
              <div>
                <label htmlFor="user">
                  <Translate contentKey="lxmcmsApp.employee.user" />
                </label>
                <div>
                  <Controller
                    control={control}
                    ...
                    render={({ field, fieldState }) => (
                      <Dropdown
                        ...
                        tooltipOptions={{ position: 'top' }}
                        tooltip={translate('lxmcmsApp.employee.help.user')}
                      />
                    )}
                  />
                </div>
              ...
              <div>
                <label htmlFor="reportsTo">
                  <Translate contentKey="lxmcmsApp.employee.reportsTo" />
                </label>
                <div>
                  <Controller
                    control={control}
                    ...
                    render={({ field, fieldState }) => (
                      <Dropdown
                        ...
                        tooltipOptions={{ position: 'top' }}
                        tooltip={translate('lxmcmsApp.employee.help.reportsTo')}
                      />
                    )}
                  />
                </div>
