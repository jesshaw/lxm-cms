...
export const EmployeeDetail = () => {
  ...
  return (
    <div className="l-card">
      <h5>
        <Translate contentKey="lxmcmsApp.employee.detail.title">Employee</Translate>
      </h5>
      <div className="l-form">
        ...
        <div>
          <label id="title" data-pr-position="top" data-pr-at="left+5 top-5" data-pr-tooltip={translate('lxmcmsApp.employee.help.title')}>
            <Translate contentKey="lxmcmsApp.employee.title">Title</Translate>
          </label>
        ...
        <div>
          <label
            ...
            data-pr-tooltip={translate('lxmcmsApp.employee.help.nickName')}
          >
            <Translate contentKey="lxmcmsApp.employee.nickName">Nick Name</Translate>
          </label>
        ...
        <div>
          <label>
            <Translate contentKey="lxmcmsApp.employee.user">User</Translate>
          </label>
          <div>{employeeEntity.user ? employeeEntity.user.login : ''}</div>
        </div>
        <div>
          <label>
            <Translate contentKey="lxmcmsApp.employee.reportsTo">Reports To</Translate>
          </label>
